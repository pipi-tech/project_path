#!/bin/bash
# WHAT:  Registry and session commands — reg list/show/history/remove, session show/history/find/active/clean
# WIRES: Sourced by functions.sh → reads/writes data/registry.conf and data/registry.txt → queries data/log/
# WHY:   Interface layer for project identity store and session audit trail
